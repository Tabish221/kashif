...
<body>
   ...
   <section class="mainBanner homeBanner" style="background-image: url(assets/images/banner/bg-banner.jpg);">
      ...
      <div class="container-fluid">
         ...
         <div class="mainBanner-cont">
            <h2 class=" wow fadeInUp" data-wow-delay="0.2s">Unrivaled Excellence in</h2>
            <h1 class="wow fadeInUp" data-wow-delay="0.3s">Gold Refining</h1>
            <p class="wow fadeInUp" data-wow-delay="0.4s">SGL is a Tanzanian-based gold refinery, leveraging decade-long expertise to refine and trade fine gold bullion while prioritising the well-being of miners and the environment.</p>
            <p class="wow fadeInUp" data-wow-delay="0.4s">At SGL, it's more than gold; it's about people.</p>

            <div class="mn-btn" class="wow fadeInDown" data-wow-delay="0.3s">
   ...
   <section class="winningSection">
      <div class="container-fluid">
         <div class="winningSec-hd wow fadeInLeft" data-wow-delay="0.2s">
            <h5>
               <div class="icon">
                  <svg width="43" height="46" viewBox="0 0 43 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path d="M28.6141 21.3638L19.1228 11.8725L21.6252 9.37012L35.3883 23.1332L21.6252 36.8962L19.1228 34.3938L28.6141 24.9027H7.07715V21.3638H28.6141Z" fill="#FCC78C" />
                  </svg>
               </div>
               Empowering Miners
            </h5>
            <h6>Empowering local miners since 2019</h6>
            <span>2019</span>
         </div>

         <div class="winningSec-img wow zoomIn" data-wow-delay="0.2s">
            <div class="bg">
               <img src="assets/images/home/winningSec-bg.jpg" alt="Background">
            </div>
            <div class="cont">
               <h6>
                  <div class="icon">
                     <img src="assets/images/home/icon.png" alt="Icon">
                  </div>
                  Mr John Doe
               </h6>
               <h5>MINER OF THE MONTH</h5>
            </div>
            <div class="user">
               <img src="assets/images/home/winningSec-user.png" alt="Winning User">
            </div>
         </div>

         <div class="winningSec-cont">
            <div class="row">
               <div class="col-md-6">
                  <p class="wow fadeInDown" data-wow-delay="0.2s">As a value-driven firm, SGL maintains close partnerships with artisanal miners and ensures responsible mining practices.</p>
               </div>

               <div class="col-md-6">
                  <p class="wow fadeInDown" data-wow-delay="0.3s">This approach fosters a mutually beneficial relationship, benefiting both miners and the regions’s thriving gold industry.</p>
               </div>
            </div>

            <a href="#" class="wow fadeInDown" data-wow-delay="0.2s">
               Learn More
               <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12.9323 7.4556L7.23308 1.59379L8.73566 0.0483398L17 8.54841L8.73566 17.0483L7.23308 15.5029L12.9323 9.64121H0V7.4556H12.9323Z" fill="#FCC78C" />
               </svg>
            </a>
         </div>
      </div>
   ...
   <section class="homeSection1">
      <div class="container-fluid h-100">
         <div class="row align-items-center justify-content-between">
            <div class="col-md-4 h-100">
               <div class="hsec1-main">
                  <div class="hsec1-card wow fadeInLeft" data-wow-delay="0.2s">
                     ...
                     <p>We provide safety gear to miners and refiners so they can protect themselves from harm and continue their service to the gold industry for years to come.</p>
                  </div>

                  <div class="hsec1-card wow fadeInLeft" data-wow-delay="0.4s">
                     <h5>
                        <div class="icon">
            ...
            <div class="col-md-4 h-100">
               <div class="hsec1-main">
                  <div class="hsec1-card wow fadeInRight" data-wow-delay="0.2s">
                     <h5>
                        <div class="icon">
                  ...
                  <div class="hsec1-card wow fadeInRight" data-wow-delay="0.4s">
                     <h5>
                        <div class="icon">
   ...
   <!-- THIS IS SAME OLD -->
   <section class="aboutSection homeAboutSection">
   ...
   <section class="homeVideoSection">
      <div class="hVidSec-after">
         <video muted loop id="secVid">
            <source src="assets/video/refiningvideo.mp4" type="video/mp4">
         </video>
      </div>
      <div class="container-fluid">
         <div class="hvideoSec-hd wow fadeInLeft" data-wow-delay="0.2s">
            <h5>
               <div class="icon">
                  <svg width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path d="M21.614 12.3527L12.1227 2.86137L14.625 0.359009L28.3881 14.1221L14.625 27.8851L12.1227 25.3827L21.614 15.8916H0.0770264V12.3527H21.614Z" fill="#FCC78C" />
                  </svg>
               </div>
               SGL Refinery
            </h5>
         ...
         <div class="hvideoSec-playBtn vdStart wow zoomIn" data-wow-delay="0.3s">
            <a href="#">
               <div class="">
                  <svg width="22" height="24" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path d="M20.0981 10.2786C21.4049 11.0533 21.4049 12.9447 20.0981 13.7194L11.825 18.6241L3.44085 23.3365C2.11655 24.0808 0.478589 23.1351 0.461049 21.6161L0.350002 11.999L0.46105 2.38196C0.47859 0.862915 2.11655 -0.0827651 3.44085 0.661565L11.825 5.37393L20.0981 10.2786Z" fill="white" />
                  </svg>
               </div>
            </a>
         </div>

         <div class="hvideoSec-cont">
            <div class="row">
               <div class="col-md-7 wow fadeInLeft" data-wow-delay="0.4s">
                  <p>Backed by state-level support and an annual refining capacity of 30 tonnes, SGL Refinery is the right gold refining partner for you.</p>
               </div>
   ...
   <section class="homeSection2">
      <div class="container">
         <div class="hsec2-main mn-hd">
            <h6 class=" wow fadeInDown" data-wow-delay="0.3s">Why partner with</h6>
            <h4 class=" wow fadeInDown" data-wow-delay="0.4s">SGL Refinery</h4>
         </div>
      </div>
   </section>
         ...
         <div class="hsec3-main">
            <div class="row align-items-end">
               ...
               <div class="col-md-4 wow fadeInUp" data-wow-delay="1.2s">
                  <div class="hsec3-card hsec3-card2">
                     <div class="icon">
                        <span>01</span>
                     </div>
               ...
               <div class="col-md-4 wow fadeInUp" data-wow-delay="1.9s">
                  <div class="hsec3-card hsec3-card3">
                     <div class="icon">
                        <span>03</span>
                     </div>
   ...
   <section class="mapSection homeMapSection">
      <div class="container">
         <div class="mapSec-hd mn-hd">
            <h5 class=" wow fadeInLeft" data-wow-delay="0.3s">
               <div class="icon">
                  <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path
                        d="M21.614 12.8623L12.1227 3.37102L14.625 0.868652L28.3881 14.6318L14.625 28.3947L12.1227 25.8923L21.614 16.4012H0.0770264V12.8623H21.614Z"
                        fill="#FCC78C" />
                  </svg>
               </div>
            ...
            <h4 class=" wow fadeInLeft" data-wow-delay="0.4s">Exporting pure gold <br> bullion to 5+ gold hub countries</h4>
         </div>

         <div class="mapSec-map text-center wow fadeInUp" data-wow-delay="0.3s">
   ...
   <section class="newsSection">
      <div class="container">
         <div class="newsSec-top">
            <div class="row align-items-end">
               <div class="col-md-8">
                  <div class="newsSec-hd mn-hd wow fadeInDown" data-wow-delay="0.3s">
                     <h5>
                        <div class="icon">
                           <svg width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path
                                 d="M22.1338 12.3638L12.6425 2.87248L15.1448 0.370117L28.9079 14.1332L15.1448 27.8962L12.6425 25.3938L22.1338 15.9027H0.596802V12.3638H22.1338Z"
                                 fill="#FCC78C" />
                           </svg>
                        </div>
                        Newsroom
                     ...
                     <h4>Our latest achievements and contributions</h4>
                  </div>
               </div>

               <div class="col-md-4">
                  <div class="newsSec-btn mn-btn text-end wow fadeInUp" data-wow-delay="0.3s">
                     <a href="#">
                        Read More
                        <div class="icon">
                           <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path
                                 d="M13.4323 7.40726L7.73308 1.54545L9.23566 0L17.5 8.50007L9.23566 17L7.73308 15.4546L13.4323 9.59287H0.5V7.40726H13.4323Z"
                                 fill="#FCC78C" />
                           </svg>
                        </div>
                     </a>
   ...
   <section class="gallerySection">
      <div class="gallerySec-main">
         <div class="container-fluid">
            <div class="contactSec-hd mn-hd wow fadeInDown" data-wow-delay="0.3s">
               <h4>SAB Gold Limited</h4>
               <p>At SGL, it's more than gold; it's about people.</p>
            </div>

            <div class="contactSec-img  wow zoomIn" data-wow-delay="0.4s">
   ...
   <section class="contactSection homeContactSection">
      <div class="container-fluid">
   ...
   <!-- <script>
      ...
      gsap.utils.toArray("section").forEach((section, i) => {
         ScrollTrigger.create({
            ...
            pinSpacing: false, // No extra space is added after the section
